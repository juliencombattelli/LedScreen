...
class Displayable : protected Rect
{
public:
	...
	led_state_t get_led_state(uint16_t p_x, uint16_t p_y) const;

private:
	Effect m_effect;

	virtual led_state_t get_value(uint16_t p_x, uint16_t p_y) const = 0;
